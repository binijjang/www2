...
<body>
    <div class="wrap">
        ...
        <div class="sub_menu">
            ...
            <ul class="sub_nav">
                <li class="current"><a href="sub6_1.html">공지사항</a></li>
                <li class=""><a href="sub6_2.html">자주묻는질문</a></li>
                <li class=""><a href="sub6_3.html">온라인상담</a></li>
                <li class=""><a href="sub6_4.html">채용FAQ</a></li>
            </ul>
        </div>
        ...
        <article id="content">
            <div class="title_area">
                ...
                <h2>공지사항</h2>
                <p>유한양행 및 이해관계자의 <strong class="emphasis">부패행위</strong>나 <strong class="emphasis">충분히 부패</strong>로<br>
                    인지될 수 있는 경우, <strong class="emphasis">이에 대한 제보를 받고 있습니다.</strong></p>
            </div>
